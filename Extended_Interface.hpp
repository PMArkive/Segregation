...
void Implement_Extended_Interface()
{
	auto Create_Console_Variable = [](Interface_Structure* Variable, char* Name, char* Value, void* Handler)
	{
		...
		Create_Console_Variable_Type(539131040)(Variable, Name, Value, nullptr, nullptr, Handler);
	...
	Create_Console_Variable(&Interface_Bruteforce_Memory, (char*)"Bruteforce_Memory", (char*)"1", (void*)Bruteforce_Reset_Memory);
	...
	Create_Console_Variable(&Interface_Alternative, (char*)"Alternative", (char*)"0", nullptr);
	...
	Create_Console_Variable(&Interface_Aim_Intersection, (char*)"Aim_Intersection", (char*)"1", nullptr);
